...
(function(){
  const ACRONYM_PATTERN = /^(2d|3d|4d|rgb|rgbd|rgb-d|slam|lidar|cnn|rnn|gan|svm|ml|ai|nlp|uav|imu|sar|bim|ifc|idm|mvd|gpr|mep|teaser|vlm|llm|qa|hvac|lod2|lod3|lod4|ui|pcd|fob|cif|dap)$/i;
